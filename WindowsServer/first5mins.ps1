...
Invoke-WebRequest -Uri "https://psg-prod-eastus.azureedge.net/packages/packagemanagement.1.1.0.nupkg" -OutFile "C:\Program Files\WindowsPowerShell\Modules\packagemanagement.1.1.0.nupkg"
